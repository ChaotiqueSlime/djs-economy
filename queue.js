class Queuing {
    ...
    addToQueue(object, firstElementExecute = true, notExecButSkip = false) {
        return new Promise((resolve, reject) => {
            let funcType = false; if (object.afterEvent) { if (!object.afterEvent.emitter || !object.afterEvent.event) return reject("Missing emitter or event options in afterEvent"); }
    ...
    _executeQueue(resolve, reject) {
        if (this.queue.length == 0) return; if (this.paused) return;
        else {
